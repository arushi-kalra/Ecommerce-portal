...
var ApiNotFound = /** @class */ (function () {
    function ApiNotFound(res, message, meta) {
    ...
    Object.defineProperty(ApiNotFound.prototype, "code", {
        get: function () {
    ...
    ApiNotFound.prototype.raw = function () {
        this.res.status(this.code).send(this.message);
    };
    ApiNotFound.prototype.jsend = function () {
        this.res.status(this.code).json(__assign(__assign({}, this.meta), { status: this.status, message: this.message }));
    };
    ApiNotFound.status = 'error';
    ApiNotFound.code = http_status_1.default.NOT_FOUND;
    return ApiNotFound;
}());
